...
import useEventStore, { useDisplayEvents } from '@store/event-store/useEventStore.ts';
...
export default function ExportDialog() {
  ...
  const downloadEvents = (events: TWEvent[]) => {
    ...
    >
      ...
      <DialogContent>
        <VStack left>
          ...
          <Typography sx={{ pt: 5 }}>
            You can choose to download all events (default) or only the filtered events.
            This allows you to filter to the events you want to save before downloading.
          </Typography>
        </VStack>
      </DialogContent>
      <DialogActions>
