...
import useTagColors, {
  CustomPaletteColor,
} from '@pages/telemetry-viewer-page/features/dialogs/tag-editor-dialog/hooks/useTagColors.ts';
import TagBase from '@pages/telemetry-viewer-page/features/dialogs/tag-editor-dialog/parts/TagBase.tsx';
